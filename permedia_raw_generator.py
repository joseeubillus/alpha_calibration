...
path = 'C:/Users/BEGuser/Box/2022-2023 GRA/Permedia_Ubillus/test_3d/test_ml_ij.tif'
...
filename = 'model_3D.raw'
with open(filename, 'w') as f:
    f.write('# .raw version 0.700\n')
    f.write('extents: ' + str(dim3) + ' ' + str(dim4) + ' ' + str(dim5) + '\n')
    f.write('origin: 0 0 0\n')
